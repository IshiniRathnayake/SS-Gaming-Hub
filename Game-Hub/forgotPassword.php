...
body {
    ...
    background-image: url('assets/img/man1.png'), url('assets/img/man1.png'); /* Path to your images */
    background-size: contain; /* Ensures the images do not cover the full width */
    background-repeat: no-repeat; /* Prevents repeating of the images */
    background-position: left center, right center; /* Positions the images to the left and right sides */
    background-attachment: fixed; /* Keeps the images fixed during scroll */
}
